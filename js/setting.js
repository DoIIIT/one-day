...
var colorComb={
    "dawn":{"b": 'rgb(66, 134, 244)',"sb":buildSequentialScale([230,320],[0.22,0.66],[0.72,0.91]),"s":d3.interpolatePuRd},
    "blueMorning":{"s":d3.interpolateYlGnBu,"sb":buildSequentialScale([45,230],[0.53,0.8],[0.29,0.7]),"b":"rgb(0, 39, 104)"},
    "redOrange":{"sb":buildSequentialScale([0,57],[0.65,1],[0.94,0.98]),"s":d3.interpolateRdYlBu,"b":"rgb(255, 127, 0)"},
    "totalDark":{"s":buildSequentialScale([45,72],[0.95,1],[0.6,0.1]),"b":"rgb(0,0,0)","o":[0.7,1]},
    "dark":{"s":buildSequentialScale([44,63],[0.95,1],[0.80,0.99]),"b":"rgb(82, 98, 124)","o":[0.8,1]}
}
